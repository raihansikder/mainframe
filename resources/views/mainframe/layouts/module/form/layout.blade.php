@extends('mainframe.layouts.module.layout')
...
@section('content')
    <div class="col-md-12 no-padding">
        ...
        @if (View::exists('modules.'.$module_name . '.form'))
            @include('mainframe.modules.'.$module_name . '.form')
        @endif
        {{--Form actions--}}
...
@section('js')
    ...
    use App\Module;$redirect_success = '#new';
    if (isset($$element)) {
