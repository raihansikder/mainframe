...
@endsection
{{--@include('mainframe.form-elements.text.textarea',['var'=>['name'=>'select_columns_csv','label'=>'Select columns', ['params'=>['class'=>'tag']],'container_class'=>'col-md-2']])--}}
@include('mainframe.form-elements.text.textarea',['var'=>['name'=>'show_columns_csv','label'=>'Columns', ['params'=>['class'=>'tag']],'container_class'=>'col-md-2']])
@include('mainframe.form-elements.text.textarea',['var'=>['name'=>'alias_columns_csv','label'=>'Matching tiles', ['params'=>['class'=>'tag']],'container_class'=>'col-md-2']])
{{--@include('mainframe.form-elements.text.textarea',['var'=>['name'=>'additional_conditions','label'=>'Additional conditions','container_class'=>'col-md-2']])--}}
{{--@include('mainframe.form-elements.text.input-text',['var'=>['name'=>'group_by','label'=>'Group by','container_class'=>'col-md-2']])--}}
@include('mainframe.form-elements.text.input-text',['var'=>['name'=>'order_by','label'=>'Order by','container_class'=>'col-md-2']])
@include('mainframe.form-elements.text.input-text',['var'=>['name'=>'group_by','label'=>'Group by','container_class'=>'col-md-2']])
