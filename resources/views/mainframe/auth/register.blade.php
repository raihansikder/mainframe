...
@section('content')
    ...
    <div class="card-body">
        ...
        @include('mainframe.form.text',['var'=>['name'=>'first_name','label'=>'First Name', 'container_class'=>'col-sm-12']])
        @include('mainframe.form.text',['var'=>['name'=>'last_name','label'=>'Last Name', 'container_class'=>'col-sm-12']])
