...
@section('content')
    ...
    <div class="card-body">
        ...
        {{ Form::open(['route' => 'register','class'=>"user-registration-form", 'name'=>'user_registration_form']) }}

        <input type="hidden" name="group_ids[]" value="{{$group->id}}">
        @include('mainframe.form.input.text',['var'=>['name'=>'first_name','label'=>'First Name', 'container_class'=>'col-sm-12']])
        @include('mainframe.form.input.text',['var'=>['name'=>'last_name','label'=>'Last Name', 'container_class'=>'col-sm-12']])
        ...
        <div class="form-group row mb-0">
            <div class="col-md-12">
                <button type="submit" class="btn btn-primary btn-block lb-bg">{{ __('Register User') }}</button>
            </div>
        </div>
