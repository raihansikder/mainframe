...
@section('content')
    <div class="col-md-12 no-padding">
        ...
        {{--    Form inputs: starts    --}}
        {{--   --------------------    --}}
        @include('mainframe.form-elements.text.input-text',['var'=>['name'=>'name','label'=>'Name (table name)','editable'=>false]])
        ...
        @include('mainframe.form-elements.select.select-ajax',['var'=>['label' => 'Parent', 'name' => 'parent_id', 'table' => 'modules']])
        @include('mainframe.form-elements.select.select-model',['var'=>['name'=>'module_group_id','label'=>'Module group', 'table'=>'module_groups']])
        ...
        @include('mainframe.form-elements.text.input-text',['var'=>['name'=>'default_route','label'=>'Default route name','editable'=>false]])
