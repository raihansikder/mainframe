...
/* change product count value from @var $product_count */
...
<div class="row">
    <div class="col-md-12">
        <b style="padding-left:5%;">Top {{ $show }} Purchased Products: Prior Month*</b>
    ...
    <script type="text/javascript">
        ...
        function drawStacked() {
            ...
            google.visualization.events.addListener(chart, 'error', function (err) {
                ...
                // remove all errors
                google.visualization.errors.removeAll(document.getElementById('top_purchases_chart_div'));
            });
