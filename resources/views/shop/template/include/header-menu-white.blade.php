...
$user = $user ?? user();
?>
<header class="site-header inner-header" style="border: 0">
...
@section('js')
    ...
    <script>
        /**
         * Make toggle button white.
         */
        $('.toggle-button').addClass('white-toggle');
        $('#login').removeClass('text-black').addClass('text-white');
    </script>
@stop
