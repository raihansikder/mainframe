 ...
 * @var $module_name           string 'affiliates'
 * @var $mod                   \App\Module
 * @var $affiliate             \App\Affiliate Object that is being edited
 * @var $element               string 'affiliate'
...
@include('form.input-text',['var'=>['name'=>'url','label'=>'URL','container_class'=>'col-md-6']])
...
@section('js')
    ...
    @if(!isset($$element))
        <script type="text/javascript">
            ...
            // during creation of an element. As this stage $$element or $affiliate(module
    ...
    @else
        <script type="text/javascript">
            ...
            // during update the variable $$element or $affiliate(module
            // name singular) is set, and id like other attributes of the element can be
            // accessed by calling $$element->id, also $affiliate->id
            // Following the convention of spyrframe you are only allowed to call functions
            /*******************************************************************/
