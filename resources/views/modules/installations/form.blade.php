 ...
 * @var $module_name           string 'Installations'
 * @var $mod                   \App\Module
 * @var $Installation             \App\Installation Object that is being edited
 * @var $element               string 'Installation'
...
@include('form.input-text',['var'=>['name'=>'device_token','label'=>'Device token']])
@include('form.input-text',['var'=>['name'=>'user_id','label'=>'Installer user ID']])
@include('form.input-text',['var'=>['name'=>'ref_user_id','label'=>'Referrer user ID']])
@include('form.input-text',['var'=>['name'=>'ref_user_uuid','label'=>'Referrer user UUID']])
@include('form.input-text',['var'=>['name'=>'ref_recommendurl_id','label'=>'Referrer recommendation ID']])
@include('form.input-text',['var'=>['name'=>'ref_recommendurl_uuid','label'=>'Referrer recommendation UUID']])
@include('form.input-text',['var'=>['name'=>'ref_event','label'=>'Referrer event']])
@include('form.input-text',['var'=>['name'=>'referral_id','label'=>'Referral ID']])
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function addValidationRulesForSaving() {
            ...
            $("input[name=device_token]").addClass('validate[required]');
        }
    </script>
    @if(!isset($$element))
        <script type="text/javascript">
            ...
            // during creation of an element. As this stage $$element or $Installation(module
    ...
    @else
        <script type="text/javascript">
            ...
            // during update the variable $$element or $Installation(module
            // name singular) is set, and id like other attributes of the element can be
            // accessed by calling $$element->id, also $Installation->id
            // Following the convention of spyrframe you are only allowed to call functions
            /*******************************************************************/
