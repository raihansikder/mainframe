 ...
 * @var $module_name           string 'splitselections'
 * @var $mod                   \App\Module
 * @var $splitselection             \App\Splitselection Object that is being edited
 * @var $element               string 'splitselection'
...
@section('js')
    ...
    @if(!isset($$element))
        <script type="text/javascript">
            ...
            // during creation of an element. As this stage $$element or $splitselection(module
    ...
    @else
        <script type="text/javascript">
            ...
            // during update the variable $$element or $splitselection(module
            // name singular) is set, and id like other attributes of the element can be
            // accessed by calling $$element->id, also $splitselection->id
            // Following the convention of spyrframe you are only allowed to call functions
            /*******************************************************************/
