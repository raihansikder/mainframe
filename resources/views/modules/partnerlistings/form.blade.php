...
@include('form.input-text',['var'=>['name'=>'url','label'=>'URL','container_class'=>'col-md-12']])
...
@include('form.select-array',['var'=>['name'=>'is_featured','label'=>'Featured?', 'options'=>['0'=>'No','1'=>'Yes'],'editable' =>user()->isSuperUser()]])
@include('form.select-array',['var'=>['name'=>'logo_position','label'=>'Featured Logo Alignment', 'options'=>kv(\App\Partnerlisting::$logo_positions)]])
{{-- Normal text field --}}
