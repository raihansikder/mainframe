 ...
 * @var $module_name           string 'partnercategorylistings'
 * @var $mod                   \App\Module
 * @var $partnercategorylisting             \App\Partnercategorylisting Object that is being edited
 * @var $element               string 'partnercategorylisting'
...
@section('js')
    ...
    @if(!isset($$element))
        <script type="text/javascript">
            ...
            // during creation of an element. As this stage $$element or $partnercategorylisting(module
    ...
    @else
        <script type="text/javascript">
            ...
            // during update the variable $$element or $partnercategorylisting(module
            // name singular) is set, and id like other attributes of the element can be
            // accessed by calling $$element->id, also $partnercategorylisting->id
            // Following the convention of spyrframe you are only allowed to call functions
            /*******************************************************************/
