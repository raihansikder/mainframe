 ...
 * @var \App\User $user
 * @var \App\Projects\MphMarket\Modules\WarrantyOptions\WarrantyOption $element
...
@section('content')
    <div class="col-md-12 no-padding">
        ...
        @include('form.text',['var'=>['name'=>'days','label'=>'Days']])
...
@section('js')
    @parent
    @include('projects.my-project.modules.warranty-options.form.js')
@endsection