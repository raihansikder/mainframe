 ...
 * @var \App\User $user
 * @var \App\Projects\MphMarket\Modules\CommissionSchemes\CommissionScheme $element
...
@section('content')
    <div class="col-md-12 no-padding">
        ...
        @include('form.text',['var'=>['name'=>'percent','label'=>'Percent to add']])
...
@section('js')
    @parent
    @include('projects.my-project.modules.commission-schemes.form.js')
@endsection