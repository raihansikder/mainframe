 ...
 * @var $module_name           string 'recommendationvisits'
 * @var $mod                   \App\Module
 * @var $recommendationvisit             \App\Recommendationvisit Object that is being edited
 * @var $element               string 'recommendationvisit'
...
@section('js')
    ...
    @if(!isset($$element))
        <script type="text/javascript">
            ...
            // during creation of an element. As this stage $$element or $recommendationvisit(module
    ...
    @else
        <script type="text/javascript">
            ...
            // during update the variable $$element or $recommendationvisit(module
            // name singular) is set, and id like other attributes of the element can be
            // accessed by calling $$element->id, also $recommendationvisit->id
            // Following the convention of spyrframe you are only allowed to call functions
            /*******************************************************************/
