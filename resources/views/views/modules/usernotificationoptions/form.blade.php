 ...
 * @var $module_name           string 'usernotificationoptions'
 * @var $mod                   \App\Module
 * @var $usernotificationoption             \App\Usernotificationoption Object that is being edited
 * @var $element               string 'usernotificationoption'
...
@section('js')
    ...
    @if(!isset($$element))
        <script type="text/javascript">
            ...
            // during creation of an element. As this stage $$element or $usernotificationoption(module
    ...
    @else
        <script type="text/javascript">
            ...
            // during update the variable $$element or $usernotificationoption(module
            // name singular) is set, and id like other attributes of the element can be
            // accessed by calling $$element->id, also $usernotificationoption->id
            // Following the convention of spyrframe you are only allowed to call functions
            /*******************************************************************/
