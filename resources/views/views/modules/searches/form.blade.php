 ...
 * @var $module_name           string 'searches'
 * @var $mod                   \App\Module
 * @var $search             \App\Search Object that is being edited
 * @var $element               string 'search'
...
@include('form.input-text',['var'=>['name'=>'keyword','label'=>'Keyword']])
@include('form.input-text',['var'=>['name'=>'user_id','label'=>'User']])
...
@section('js')
    ...
    @if(!isset($$element))
        <script type="text/javascript">
            ...
            // during creation of an element. As this stage $$element or $search(module
    ...
    @else
        <script type="text/javascript">
            ...
            // during update the variable $$element or $search(module
            // name singular) is set, and id like other attributes of the element can be
            // accessed by calling $$element->id, also $search->id
            // Following the convention of spyrframe you are only allowed to call functions
            /*******************************************************************/
