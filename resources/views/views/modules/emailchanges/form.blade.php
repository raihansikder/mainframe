 ...
 * @var $module_name           string 'emailchanges'
 * @var $mod                   \App\Module
 * @var $emailchange             \App\Emailchange Object that is being edited
 * @var $element               string 'emailchange'
...
@section('js')
    ...
    @if(!isset($$element))
        <script type="text/javascript">
            ...
            // during creation of an element. As this stage $$element or $emailchange(module
    ...
    @else
        <script type="text/javascript">
            ...
            // during update the variable $$element or $emailchange(module
            // name singular) is set, and id like other attributes of the element can be
            // accessed by calling $$element->id, also $emailchange->id
            // Following the convention of spyrframe you are only allowed to call functions
            /*******************************************************************/
