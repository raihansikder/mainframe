 ...
 * @var $module_name           string 'firebaseentries'
 * @var $mod                   \App\Module
 * @var $firebaseentry         \App\Firebaseentry Object that is being edited
 * @var $element               string 'firebaseentry'
...
@include('form.input-text',['var'=>['name'=>'type','label'=>'Analytic entry type']])
<div class='clearfix'></div>
@include('form.input-text',['var'=>['name'=>'time','label'=>'Select Date','params'=>['class'=>'datepicker']]])

@include('form.input-text',['var'=>['name'=>'no_of_downloads','label'=>'No. of Downloads']])

<div class='clearfix'></div>
@include('form.input-text',['var'=>['name'=>'daily_active_users','label'=>'Daily active users']])

@include('form.input-text',['var'=>['name'=>'monthly_active_users','label'=>'Monthly active users']])

<div class='clearfix'></div>
@include('form.input-text',['var'=>['name'=>'daily_time_spent_on_app','label'=>'Daily time spent on app (In Second)']])

@include('form.input-text',['var'=>['name'=>'monthly_time_spent_on_app','label'=>'Monthly time spent on app (In Second)']])

<div class='clearfix'></div>
@include('form.input-text',['var'=>['name'=>'app_churn_rate','label'=>'App churn rate']])
...
@section('js')
    ...
    @if(!isset($$element))
        <script type="text/javascript">
            ...
            // during creation of an element. As this stage $$element or $firebaseentry(module
    ...
    @else
        <script type="text/javascript">
            ...
            // during update the variable $$element or $firebaseentry(module
            // name singular) is set, and id like other attributes of the element can be
            // accessed by calling $$element->id, also $firebaseentry->id
            // Following the convention of spyrframe you are only allowed to call functions
            /*******************************************************************/
