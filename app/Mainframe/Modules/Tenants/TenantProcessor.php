...
class TenantProcessor extends ModelProcessor
{
    ...
    */
    ...
    public function saving($tenant)
    {
        ...
        */
        $this->nameIsNotJoker($tenant);
        // $this->valueIsNotPrime($tenant);
        // $this->hasEnoughGunsToFight($tenant);
        // $this->heroIsNotInHospital($tenant);
